                ...
                ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return FadeInUp(
                      ...
                      child: ListTile(
                        title: Text(permit['permit_number'] ?? 'N/A'),
                        subtitle: Text(permit['vehicle_number'] ?? 'N/A'),
                        trailing: Container(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 12),
                    _buildDetailRow(
                        'Vehicle Number', permit['vehicle_number'] ?? 'N/A'),
                    ...
                    _buildDetailRow(
                        'Year', permit['vehicle_year']?.toString() ?? 'N/A'),
                    _buildDetailRow('Capacity',
                        permit['vehicle_capacity']?.toString() ?? 'N/A'),
                    const Divider(height: 24),
                    Text(
                      'Owner Information',
                      style: TextStyle(
                    ...
                    const SizedBox(height: 12),
                    _buildDetailRow(
                        'Owner Name', permit['owner_name'] ?? 'N/A'),
                    _buildDetailRow(
                        'Owner CNIC', permit['owner_cnic'] ?? 'N/A'),
                    _buildDetailRow('Email', permit['owner_email'] ?? 'N/A'),
                    _buildDetailRow('Phone', permit['owner_phone'] ?? 'N/A'),
                    _buildDetailRow(
                        'Address', permit['owner_address'] ?? 'N/A'),
                    const Divider(height: 24),
                    Text(
                      'Permit Information',
                      style: TextStyle(
                    ...
                    _buildDetailRow(
                        'Permit Type', permit['permit_type']?['name'] ?? 'N/A'),
                    _buildDetailRow('Valid From',
                        permit['valid_from']?.split('T')[0] ?? 'N/A'),
                    _buildDetailRow(
                        'Valid To', permit['valid_to']?.split('T')[0] ?? 'N/A'),
                    _buildDetailRow(
                        'Description', permit['description'] ?? 'N/A'),
                    if (permit['approved_routes'] != null)
                      _buildDetailRow(
                          'Routes', permit['approved_routes'] ?? 'N/A'),
                    const SizedBox(height: 24),
                  ],
                ),
              ),
