#!/usr/bin/env python
"""
Script to populate vehicle types with default permit durations.
Run from django shell: python manage.py shell < populate_vehicle_durations.py
Or directly: python populate_vehicle_durations.py
"""
